                ...
                return (
                  <View style={styles.scheduleContainer}>
                    ...
                    <View style={styles.weekSelector}>
                      <Ionicons name="chevron-down" size={18} color="#fff" style={styles.weekSelectorIcon} />
                      <Text style={styles.weekSelectorText}>Feb. 17 - 23, 2025</Text>
                    ...
                    <ScrollView style={styles.timetableContainer}>
                      <View style={styles.timetable}>
                        ...
                        <View style={styles.timeColumn}>
                          {['14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00'].map((time, index) => (
                        ...
                        {/* Classes grid - 7 columns (days) */}
                        <View style={styles.classesGrid}>
                          {/* This is just the structure - you'll populate with actual classes later */}
                          {[0, 1, 2, 3, 4, 5, 6].map((dayIndex) => (
                            <View key={dayIndex} style={styles.daySchedule}>
                              {/* Empty slots for now - you'll replace these with actual classes */}
                              {[0, 1, 2, 3, 4, 5, 6, 7, 8].map((timeIndex) => (
                                <View key={timeIndex} style={styles.emptySlot} />
                              ))}
                              
                              {/* This is a sample class block - you'll generate these dynamically later */}
                              {dayIndex === 0 && (
                                <View style={[styles.classBlock, { top: 40, height: 80 }]}>
                                  <Text style={styles.classCode}>SOEN 340</Text>
                                  <Text style={styles.classType}>LEC</Text>
                                </View>
                              )}
                            </View>
                          ))}
