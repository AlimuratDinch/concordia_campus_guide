...
import { parseCoordinates, getCenterFromCoordinates, mapCoordinates } from "./utils/coordinateHelpers";
...
export default function Loyola_Map() {
  ...
  // Function to center map on a building using its first coordinate
